...
function addSiswa($data)
{
	...
	$query = mysqli_query($conn, "INSERT INTO warga VALUES ('$id_warga', '$nik', '$nama_warga', '$jenis_kelamin', '$alamat', '$no_rumah', '$status')");
	return mysqli_affected_rows($conn);
}
...
function editSiswa($data)
{
	...
	$no_rumah = htmlspecialchars($data['no_rumah']);
	$status = htmlspecialchars($data['status']);
	$query = mysqli_query($conn, "UPDATE warga SET id_warga = '$id_warga', nik = '$nik', nama_warga = '$nama_warga', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', no_rumah = '$no_rumah', status = '$status' WHERE id_warga = '$id_warga'");
	return mysqli_affected_rows($conn);
}
