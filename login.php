...
<head>
	...
	<title>Login Kas Rt Ds.Pundenrejo</title>
	<style>
		* {
			margin: 0;
			padding: 0;
		...
		body {
			...
			background-image: url(assets/img/img_properties/logo_login2.jpg);
		}
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark rounded border border-dark" style="background-color: rgba(180,190,196,.6);">
				<h3 class="text-center">UANG KAS RT 01</h3>
				<h3 class="text-center">DESA PUNDENREJO </h3>
				<form method="post">
